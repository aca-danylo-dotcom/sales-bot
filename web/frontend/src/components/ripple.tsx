...
/** Всё, что в панели выглядит и работает как кнопка: пилюли, вкладки,
    переключатели рядов в шапке графика и ячейки меню разделов.

    У меню разделов берём именно ячейку, а не ссылку вокруг неё: круг
    обрезается по рамке найденного узла, и по ссылке он вышел бы квадратным
